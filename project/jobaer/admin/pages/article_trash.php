...
if (isset($_GET['status'])) {
    ...
    else if ($_GET['status'] == 'undo') {
        $news_id = $_GET['news_id'];
        $message = $sup_obj->recover_news_by_news_id($news_id);
    }
    
}
$query_result = $sup_obj->select_all_news_deleted();
?>
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
...
<div class="row-fluid sortable">		
    ...
    <?php } ?>
                                ...
                                <a class="btn btn-danger" href="?status=undo&news_id=<?php echo $data['news_id']; ?>" title="undo" onclick="return check_delete(); ">
